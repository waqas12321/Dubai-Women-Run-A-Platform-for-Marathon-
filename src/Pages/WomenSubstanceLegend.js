...
const WomenSubstanceLegend = () => {
    const {legendData}=useCampaignHook();
    console.warn(legendData)
...
Women of Substance - LEGEND
    </div>
   
    <div className='data'>
 {
    legendData.map((currElem)=>{
...
export default WomenSubstanceLegend;
